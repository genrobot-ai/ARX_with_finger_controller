...
class GripperSystem:
    ...
    def __init__(
        ...
        camera_fps: int = 30,
        encoder_freq: float = 100,
        tactile_freq: Optional[float] = None,
    ):
        """
        ...
        Args:
            ...
            encoder_freq: Encoder polling rate in Hz (default 100).
            tactile_freq: Tactile polling rate in Hz; None = no tactile polling.
        """
        self.running = True
    ...
    def start(self):
        ...
        try:
            self.databus = DataBus(
                ...
                baudrate=921600,
                encoder_freq=self.encoder_freq,
                tactile_freq=self.tactile_freq,
